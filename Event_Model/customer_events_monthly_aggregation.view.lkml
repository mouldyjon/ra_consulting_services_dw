view: customer_events_monthly_aggregation {
    derived_table: {
      ...
      explore_source: customer_master {
        ...
        column: event_ts_month { field: customer_events.event_ts_month }
        filters: {
    ...
    dimension: event_ts_month {
      label: "Event History Event Month"
      type: date_month
    }
  }
